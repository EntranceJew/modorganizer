...
{
  m_ContentIcons[ModInfo::CONTENT_PLUGIN]    = std::make_tuple(":/MO/gui/content/plugin", tr("Game Plugins (ESP/ESM/ESL/ESU)"));
...
QString ModList::getColumnToolTip(int column)
{
  switch (column) {
    ...
    case COL_CONTENT:  return tr("Depicts the content of the mod:<br>"
                                 "<table cellspacing=7>"
                                 "<tr><td><img src=\":/MO/gui/content/plugin\" width=32/></td><td>Game plugins (esp/esm/esl/esu)</td></tr>"
